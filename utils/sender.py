...
def send_slack_msg(env, webhook_url, info):
    # DEV or PROD
    ...
    # partitions, t, broker_name, account_no, is_buy, order_type, order_price, order_quantity, avg_price, init_deposit, remain_deposit
